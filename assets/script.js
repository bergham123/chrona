  ...
  function openProfileModal() {
    ...
    $('#changePassBtn').onclick = async () => {
      ...
      try {
        ...
        $('#profileForm').querySelector('[name="currentPassword"]').value = '';
        $('#profileForm').querySelector('[name="newPassword"]').value = '';
      } catch (err) { toast(err.message); }
    };
  }
